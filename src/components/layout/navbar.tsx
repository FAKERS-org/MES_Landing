...
const menuKeys: { key: keyof NavT; href?: string }[] = [
  { key: "home" },
  { key: "purpose" },
  { key: "about" },
  { key: "contact" },
  ...
  return (
    <div className="flex flex-col">
      <nav className="w-full bg-white">
        <div className="flex items-center justify-between px-[5%] sm:px-[8%] lg:px-[100px] py-[32px] h-auto w-full">
          {/* Start content */}
          ...
          <div className="flex items-center gap-3">
            {!isLoggedIn ? (
              ...
              <span className="text-sm font-medium text-[#06598F]">
                {t.profile}
              </span>
            )}
          </div>
      ...
      {isDialogOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <form
            ...
            className="bg-white rounded-lg p-6 w-[320px] shadow-xl"
          >
            <h2 className="text-lg font-semibold mb-4 text-[#06598F]">
              {t.enterPassword}
            </h2>
            <input
              type="password"
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                type="submit"
                className="px-4 py-2 text-sm text-white bg-[#0162A3] hover:bg-[#003D7A] rounded"
              >
                {t.submit}
              </button>
            </div>
      ...
      {isSuccessDialogOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-lg p-6 w-[320px] shadow-xl">
            <h2 className="text-lg font-semibold mb-2 text-[#06598F]">
              {t.success}
            </h2>
            <p className="text-sm text-gray-600 mb-4">{t.successMessage}</p>
